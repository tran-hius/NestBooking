import { UserStatus, Prisma, User } from "../../../../generated/prisma";
...
export class UserService implements IUserService {
  ...
  async updateUserAdmin(
    ...
    const executeTx = tx
      ? (fn: (t: TxClient) => Promise<any>) => fn(tx)
      : (fn: (t: TxClient) => Promise<any>) => prisma.$transaction(fn);
    ...
    return executeTx(async (prismaTx: TxClient) => {
      ...
      if (dto.fullName !== undefined || dto.phoneNumber !== undefined || dto.address !== undefined) {
        ...
        if (dto.phoneNumber !== undefined) profileData.phoneNumber = dto.phoneNumber;
