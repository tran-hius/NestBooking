...
export class RoomTypeService implements IRoomTypeService {
  ...
  constructor(roomTypeRepo: IRoomTypeRepository, hotelRepo: IHotelRepository, uploadService: IUploadService) {
  ...
  async getRoomTypeById(id: string, tx?: any): Promise<RoomTypeResponseDto | null> {
