...
const roomTypeService = new RoomTypeService(roomTypeRepository, hotelRepository, uploadService);
const roomTypeController = new RoomTypeController(roomTypeService);
// =====================================================
// PUBLIC APIs
// =====================================================
router.get("/:hotelId/public", 
/*
...
*/
authMiddleware, roleMiddleware([Role.AGENT, Role.ADMIN]), asyncHandler(roomTypeController.getRoomTypesByHotel));
router.post("/:hotelId", 
/*
  ...
  #swagger.security = [{ "bearerAuth": [] }]
*/
authMiddleware, roleMiddleware([Role.AGENT, Role.ADMIN]), validate(CreateRoomTypeSchema), asyncHandler(roomTypeController.createRoomType));
router.put("/:id", 
/*
  #swagger.path = '/api/room-types/{id}'
  #swagger.tags = ['RoomTypes']
  ...
  #swagger.security = [{ "bearerAuth": [] }]
*/
authMiddleware, roleMiddleware([Role.AGENT, Role.ADMIN]), validate(UpdateRoomTypeSchema), asyncHandler(roomTypeController.updateRoomType));
router.delete("/:id", 
/*
  #swagger.path = '/api/room-types/{id}'
  #swagger.tags = ['RoomTypes']
  ...
  #swagger.security = [{ "bearerAuth": [] }]
*/
authMiddleware, roleMiddleware([Role.AGENT, Role.ADMIN]), asyncHandler(roomTypeController.deleteRoomType));
...
/*
  ...
  #swagger.security = [{ "bearerAuth": [] }]
*/
authMiddleware, roleMiddleware([Role.AGENT, Role.ADMIN]), validate(AddRoomTypeImagesSchema), asyncHandler(roomTypeController.addRoomTypeImages));
...
/*
  ...
  #swagger.security = [{ "bearerAuth": [] }]
*/
authMiddleware, roleMiddleware([Role.AGENT, Role.ADMIN]), asyncHandler(roomTypeController.deleteRoomTypeImage));
