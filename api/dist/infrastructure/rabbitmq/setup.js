...
export async function setupRabbitMQBindings() {
    ...
    try {
        ...
        await channel.bindQueue(QUEUES.EMAIL_OTP_DLQ, EXCHANGES.NOTIFICATION_DLX, ROUTING_KEYS.NOTIFICATION_DEAD_LETTER);
        ...
        await channel.bindQueue(QUEUES.EMAIL_OTP, EXCHANGES.NOTIFICATION_DIRECT, ROUTING_KEYS.OTP_SEND);
        ...
        logger.info("[RabbitMQ] Khai báo Exchanges, Queues, DLQ & Bindings hoàn tất!");
    }
    finally {
        await channel.close();
    }
