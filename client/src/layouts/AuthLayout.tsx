    ...
    <div className="min-h-screen bg-slate-50">
      <header className="relative z-50 flex h-[72px] items-center border-b border-slate-200 bg-white">
        <div className="container flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2.5 text-slate-900"><span className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-400 to-blue-600 text-white shadow-lg shadow-blue-500/20"><MapPin className="h-5 w-5" /><span className="absolute bottom-1 right-1 h-1.5 w-1.5 rounded-full border border-blue-600 bg-cyan-300" /></span><span className="text-xl font-black tracking-tight sm:text-2xl">NestBooking</span></Link>
