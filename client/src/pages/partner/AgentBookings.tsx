  ...
  return (
    <div className="flex justify-end gap-2">
      ...
      {booking.status === "CHECKED_IN" && (
        <Button size="sm" className="h-8 gap-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-700" disabled={updating === booking.id} onClick={() => onAction("COMPLETED")}>
