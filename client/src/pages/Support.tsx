      ...
      <div className="container relative -mt-12">
        ...
        <div className="mt-16 grid items-start gap-10 lg:grid-cols-[1fr_320px]">
          ...
          <aside className="space-y-4 lg:sticky lg:top-24">
            ...
            <div className="rounded-[22px] border border-sky-200 bg-sky-50 p-5"><div className="flex items-center gap-3"><div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white text-sky-600 shadow-sm"><ShieldCheck className="h-5 w-5" /></div><div><div className="font-bold text-sky-900">{t("support.safeSupport")}</div><div className="text-xs text-sky-700">{t("support.safeSupportDesc")}</div></div></div><p className="mt-4 text-sm leading-relaxed text-sky-800/80">{t("support.safetyNote")}</p></div>
          </aside>
        </div>
      </div>
    </div>
