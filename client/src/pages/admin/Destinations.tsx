...
export default function Destinations() {
  ...
  return (
    <div className="space-y-6 pb-8">
      <section className="overflow-hidden rounded-[26px] border border-emerald-100 bg-gradient-to-br from-white via-emerald-50/50 to-cyan-50 p-6 shadow-sm dark:border-zinc-800 dark:from-zinc-900 dark:via-zinc-900 dark:to-emerald-950/30 md:p-7">
        <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
          <div>
            <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-emerald-100 px-3 py-1 text-xs font-semibold uppercase tracking-[0.14em] text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300"><Map className="h-4 w-4" />Destination content</div>
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            <Button onClick={openCreate} className="h-10 gap-2 rounded-xl bg-emerald-600 hover:bg-emerald-700"><Plus className="h-4 w-4" />Thêm điểm đến</Button>
          </div>
        </div>
      </section>

      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <StatCard icon={MapPin} label="Tổng điểm đến" value={destinations.length} hint="Danh mục toàn hệ thống" tone="emerald" />
